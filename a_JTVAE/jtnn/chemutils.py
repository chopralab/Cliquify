...
def tree_decomp(mol):
    ...
    # ssr = [[0, 1, 2], [0, 1, 3], [0, 2, 3]]
    cliques.extend(ssr)

    # print(get_smiles(mol))
    # print(cliques)
    # print(get_smiles(show_atom_number(mol, 'molAtomMapNumber')))
    ...
    # print()
    # for nei in nei_list2: print(nei)
        ...
        for atom in cliques[i]:
            for j in nei_list[atom]:
                ...
                if len(inter) > 2:
                    ...
                    # print('cliques[i]', cliques[i])
                    # print(get_smiles(get_clique_mol(mol, cliques[i])))
    ...
    for atom in range(n_atoms):
        ...
        rings = [c for c in cnei if len(cliques[c]) >= 3]
...
def attach_mols(ctr_mol, neighbors, prev_nodes, nei_amap):
    ...
    for nei_node in prev_nodes + neighbors:
        ...
        if nei_mol.GetNumBonds() == 0:
            ...
            # print('nei_atom', nei_atom)
            # print('amap[0]', amap)
            # print('amap[0]', amap[0])
            # print('map_num', nei_atom.GetAtomMapNum())
            ctr_atom = ctr_mol.GetAtomWithIdx(amap[0])
            # print(nei_atom.GetAtomMapNum())
            # print(ctr_atom.GetAtomMapNum())
